...
const ROUTES: RouteConfig[] = [
  ...
  { path: "/fiches-cours/maths/6e/triangles",           priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
  { path: "/fiches-cours/maths/6e/quadrilateres",       priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
  { path: "/fiches-cours/maths/6e/symetrie",            priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
  { path: "/fiches-cours/maths/6e/donnees",             priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
  { path: "/fiches-cours/maths/6e/probabilites",        priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
  { path: "/fiches-cours/maths/6e/algorithmique",       priority: 0.85, changeFrequency: "weekly", lastMod: LASTMOD_FICHES_IA },
