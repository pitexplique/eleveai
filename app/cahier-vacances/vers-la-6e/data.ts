...
export const carnet: Record<number, string> = {
  1: "Mon sac à dos est prêt, et moi aussi ! Aujourd'hui, le grand voyage vers la 6ᵉ commence au bord du lagon de l'Hermitage. L'eau est turquoise, le soleil brille : quelle belle façon de partir. Tu viens avec moi ?",
  2: "Ce matin, le lagon est calme comme un miroir. Des petits poissons jaunes et bleus passent tout près de moi. Je pourrais rester là des heures, juste à les regarder.",
  3: "Le soleil se lève doucement sur l'eau. J'écoute les vagues, je respire l'air salé. Un beau voyage, ça commence toujours par ouvrir grand les yeux.",
  4: "Dernier jour au bord de l'eau. Je trempe une dernière fois mes pattes dans le lagon tout tiède. Demain, je quitte la côte pour grimper vers les hauteurs.",
  5: "Première étape déjà terminée ! Je fais un petit signe au lagon. Là-haut m'attend une grande forêt pleine de mystères… Suis-moi, l'aventure ne fait que commencer !",
  6: "J'entre dans la forêt de Bélouve. Les tamarins sont immenses, leurs branches tordues forment des tunnels de verdure. Tout est vert, humide et calme : un vrai monde enchanté.",
  7: "Je goûte un goyavier bien mûr cueilli sur le chemin : un délice tout sucré ! La forêt offre plein de petits trésors à qui prend le temps de regarder.",
  8: "La brume descend entre les arbres et tout devient doux et cotonneux. J'avance sans bruit, comme dans un joli rêve.",
  9: "J'entends des chants d'oiseaux que je ne connais pas. Je lève la tête : des plumes colorées filent entre les feuilles. Comme la forêt est vivante !",
  10: "Je sors enfin des arbres. Au loin, une montagne fume tranquillement dans le ciel… un volcan ! Demain, je pars à sa rencontre. Mon cœur bat d'impatience.",
  11: "Me voici au pied du Piton de la Fournaise. La terre est rouge et noire, étrange et magnifique. Je monte doucement, en admirant ce drôle de paysage.",
  12: "Plus je monte, plus l'air devient frais. De petits nuages passent juste à côté de moi : j'ai l'impression de marcher dans le ciel.",
  13: "Le sol est tout noir, couvert de lave durcie en vagues figées. On dirait que la montagne a été sculptée par un géant. Quel spectacle !",
  14: "Mes pattes sont pleines de cendre, mais je souris : le bord du cratère est tout proche. Encore quelques pas et je verrai le cœur du volcan.",
  15: "J'y suis ! Le cratère s'ouvre devant moi, immense et fumant. Quelle vue ! Le voyage continue : un grand cirque sauvage m'attend, Mafate.",
  16: "J'arrive à Mafate. Ici, pas une seule route : on se déplace seulement à pied, d'îlet en îlet. C'est un coin secret, comme posé hors du temps.",
  17: "Je traverse un petit champ avant le prochain village. Une dame m'offre un sourire et un fruit. Ici, les gens sont accueillants comme nulle part ailleurs.",
  18: "Je sors ma boussole et je cherche mon chemin entre les montagnes. Se repérer, c'est un vrai petit jeu : j'adore ça !",
  19: "Le soleil tape fort et ma gourde se vide. Je bois une gorgée à l'ombre d'un arbre. Un voyageur tranquille va toujours plus loin.",
  20: "Dernier îlet de Mafate ! Je regarde le chemin parcouru et je suis tout fier. Au loin, j'entends déjà gronder les cascades…",
  21: "J'arrive près du Trou de Fer. Des cascades immenses tombent dans le vide avec un grand bruit doux. Des arcs-en-ciel dansent dans les gouttes !",
  22: "L'eau coule de partout autour de moi. Certaines chutes sont si hautes que je ne vois même pas où elles commencent. La nature est vraiment géante, ici.",
  23: "Je remplis ma gourde dans un bassin tout clair. L'eau est fraîche et transparente : un vrai cadeau du voyage.",
  24: "Je traverse un petit pont au-dessus des chutes. En dessous, l'eau gronde et scintille. C'est impressionnant… et tellement beau !",
  25: "Je quitte les cascades, le cœur léger. Devant moi se dresse le plus haut sommet de l'île : le Piton des Neiges. La dernière étape m'attend.",
  26: "Je commence l'ascension du Piton des Neiges. L'air est vif, le ciel immense. Chaque pas me rapproche un peu plus des étoiles.",
  27: "Je me lève avant le jour pour voir le soleil se lever depuis le sommet. Dans le noir, les étoiles brillent partout : c'est magique.",
  28: "Je marche dans les nuages, tout doucement. On dirait que le monde entier dort sous un grand drap blanc. Plus que quelques pas…",
  29: "J'aperçois le sommet ! Dans ma tête, je prépare déjà mon cartable : la 6ᵉ, c'est pour très bientôt. Comme je suis fier du chemin parcouru.",
  30: "Ça y est, j'ai atteint le sommet du Piton des Neiges, tout en haut de l'île ! Le soleil se lève, le monde s'étend à mes pieds… et la 6ᵉ m'ouvre ses portes. Merci d'avoir voyagé avec moi : on a réussi, ensemble ! 🎓",
};
