// /programme/anglais/<niveau> — une page par niveau, pas par notion.
...
// même profondeur. Sans lui, « anglais » serait lu comme un nom de classe et
...
const MATIERE = "anglais" as const;
