...
function Carte({ a }: { a: ActionCatalogue }) {
  ...
  return (
    ...
    >
      ...
      {/* ⚠️ PAS DE PRÉCHARGEMENT sur le lien ci-dessous (05/08/2026). Il est
          rendu en boucle sur tout le catalogue : la page en sort avec 132
          liens. Un <Link> d'App Router va chercher la charge RSC de sa
          destination dès qu'il entre dans le champ de vision, et sur une route
          statique c'est une LECTURE du cache durable — le quota ISR Reads, à
          87 % du million. Dérouler /explorer coûtait des dizaines de lectures
          pour un seul clic. Le lien reste instantané une fois cliqué. */}
      <div className="mt-4">
        {aVenir ? (
