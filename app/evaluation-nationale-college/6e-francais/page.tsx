...
export const metadata: Metadata = {
  ...
  description:
    "L'épreuve blanche de l'évaluation nationale de 6e en français : même forme que le jour J — prise en main, puis 20 questions qui défilent une par une, sans retour en arrière, en 50 minutes. Sur le programme de CM2 : comprendre ce qu'on lit, lexique, phrase et accords, temps des verbes. À la fin, le nom de chaque compétence qui a coincé et de quoi la retravailler. Gratuit, sans publicité.",
  keywords: [
