...
const KITS_ANGLAIS = [
  ...
  },
  {
    slug: "anglais-b2",
    emoji: "🎓",
    titre: KIT_ANGLAIS_B2.titre,
    niveau: "B2 · avancé",
    pitch:
      "Le vocabulaire académique en 15 fiches (analyse, démonstration, sciences, macroéconomie, géopolitique) : les mots et phrases qui sauvent, les réflexes, les faux-amis, test corrigé.",
