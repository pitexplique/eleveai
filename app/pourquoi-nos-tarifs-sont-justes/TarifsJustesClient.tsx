      ...
      <section className="mx-auto max-w-5xl px-4 py-10 sm:py-12 space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-5 space-y-3">
            ...
            {/* ⚠️ `PRIX_PROF_AN` et non `PRIX_FAMILLE_AN`, alors que les deux
                valent le même montant aujourd'hui : c'est précisément quand
                deux constantes coïncident qu'on prend l'une pour l'autre, et
                la phrase se met à mentir le jour où l'une des deux bouge. */}
            <p className="text-sm text-slate-100">
              C&apos;est aussi pour ça que le professeur qui équipe sa classe paie{" "}
              {euros(PRIX_PROF_AN)} par an — {centimes(EXEMPLE_CLASSE.parEleve)}{" "}
              par élève pour une classe de {EXEMPLE_CLASSE.eleves} — et qu&apos;il
              n&apos;a besoin de l&apos;autorisation de personne pour le faire.
            </p>
          </div>
        </div>
