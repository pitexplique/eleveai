              ...
              <div className="rounded-2xl border border-emerald-500/40 bg-gradient-to-b from-emerald-900/40 via-slate-950 to-slate-950 p-5 shadow-lg relative overflow-hidden">
                ...
                <div className="relative space-y-3">
                  ...
                  <ul className="text-xs text-slate-300 space-y-1">
                    <li>• Tu expliques ce que tu veux améliorer.</li>
                    <li>• La moulinette IA construit un prompt structuré.</li>
                    <li>• Tu obtiens un vrai plan avec des actions simples.</li>
                  </ul>
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 space-y-6">
          ...
          <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-4 text-[12px] text-slate-200">
            ...
            <p className="mt-1">
              ...
              Un espace dédié « collège & équipe éducative » arrive pour vous faire gagner du temps.
            </p>
          </div>
        </div>
      </section>
