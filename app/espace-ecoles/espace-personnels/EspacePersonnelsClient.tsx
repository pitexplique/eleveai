// app/espace-personnels/EspacePersonnelsClient.tsx
"use client";
...
export default function EspacePersonnelsClient() {
  ...
  function genererPrompt() {
    ...
    const nbEleves = form.nbEleves.trim() !== "" ? form.nbEleves.trim() : "non précisé";
    const nbProfs = form.nbProfs.trim() !== "" ? form.nbProfs.trim() : "non précisé";
          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-sm sm:text-base text-slate-700">
                Choisis un modèle (ou décris la situation en 2 minutes). EleveAI
                génère un prompt clair pour rédiger une <b>note</b>, un{" "}
                <b>protocole</b>, une <b>fiche sécurité</b>, une <b>affiche</b> ou
                un <b>message de remerciement</b>.
              </p>
            </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <select
                    value={form.typeDoc}
                    onChange={(e) =>
                      handleChange("typeDoc", e.target.value as TypeDocPersonnel)
                    }
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs sm:text-sm text-slate-900 shadow-inner focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100"
                  >
