...
const resume =
  ...
  `ce que le chef d'établissement voit de tous ses niveaux. ${montant(PRIX_ETABLISSEMENT_ELEVE_MOIS)} par élève et par mois, ` +
  `jamais plus de ${euros(PLAFOND_ETABLISSEMENT_AN)} par an quel que soit l'effectif — et aucune famille ne paie.`;
      ...
      <div className="mx-auto max-w-5xl space-y-14">
          ...
          <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-violet-500/30 bg-violet-500/5 p-5">
            <div>
              <p className="text-3xl font-black text-violet-200">
                {montant(PRIX_ETABLISSEMENT_ELEVE_MOIS)}
                <span className="ml-1 text-base font-bold text-slate-400">
                  par élève et par mois
                </span>
              </p>
              <p className="mt-1 text-sm font-semibold text-slate-300">
                Jamais plus de {euros(PLAFOND_ETABLISSEMENT_AN)} par an, quel que
                soit l’effectif — {euros(EXEMPLE_ETABLISSEMENT.total)} pour un
        ...
        <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
          ...
          <p className="text-sm text-slate-400">
            ...
            professeur ouvre le tarif de groupe de sa classe à{" "}
            {montant(PRIX_CLASSE_ELEVE_MOIS)} par élève et par mois, sans rien
            sortir de sa poche, et vous verrez ce que ça donne sur de vrais
            élèves avant d’en parler en conseil.
          </p>
        </section>
