...
MOTS_EN_L = ["lune", "lit", "livre", "lapin", "lampe"]
...
VOIX = Path(__file__).resolve().parents[3] / "public" / "sons" / "cp-lettre-l"
DUREE = {
    "00-aujourdhui": 3.34, "01-ecoute": 3.15, "02-regarde": 3.13, "03-depart": 16.74,
    "04-encore": 2.92, "05-cherchons": 4.27, "05-l-comme": 1.69, "06-lune": 1.47,
...
class _LettreLBase(Scene):
    ...
    def construct(self):
        ...
        titre_mots = Text("l comme…", font_size=50)
        ...
        relance = ecran_relance(self.vertical, "l")
...
class LettreLCp(_LettreLBase):
    """16:9, droitier."""


class LettreLCpGaucher(_LettreLBase):
    """16:9, gaucher."""

    gaucher = True


class LettreLCpPortrait(Portrait, _LettreLBase):
    """9:16, droitier."""


class LettreLCpPortraitGaucher(Portrait, _LettreLBase):
    """9:16, gaucher."""
