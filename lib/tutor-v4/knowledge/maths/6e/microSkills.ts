...
export const microSkills: MicroSkillSource[] = [
  ...
  ========================= */
  {
    id: "donnee_lire_tableau",
    label: "Lire un tableau",
    notionId: "donnees",
    prerequis: [],
  },
  {
    id: "donnee_lire_graphique",
    label: "Lire un graphique",
    notionId: "donnees",
    prerequis: ["donnee_lire_tableau"],
  },
  {
    id: "donnee_prelever",
    label: "Prélever une information",
    notionId: "donnees",
    prerequis: ["donnee_lire_tableau", "donnee_lire_graphique"],
  },
  {
    id: "donnee_comparer",
    label: "Comparer des données",
    notionId: "donnees",
    prerequis: ["donnee_prelever"],
  },
  {
    id: "donnee_interpreter",
    label: "Interpréter des données",
    notionId: "donnees",
    prerequis: ["donnee_prelever", "donnee_comparer"],
  },
  {
    id: "donnee_defis",
    label: "Défis données",
