...
export const situations: SituationSource[] = [
  ...
  {
    notionIds: ["info_nuage", "info_point_moyen", "info_ajustement_affine", "info_interpoler_extrapoler"],
  ...
  {
    notionIds: ["info_nuage", "info_point_moyen", "info_ajustement_affine", "info_interpoler_extrapoler", "info_tableur"],
  ...
  {
    notionIds: ["alea_conditionnelle", "alea_arbre", "alea_arbre_calcul", "alea_bernoulli"],
  ...
  {
    notionIds: ["alea_conditionnelle", "alea_arbre", "alea_arbre_calcul"],
  ...
  {
    notionIds: ["lin_suite_arithmetique", "lin_modeliser", "lin_seuil"],
  ...
  {
    notionIds: ["lin_affine", "lin_affine_lecture"],
    discipline: "Physique",
    situation:
  ...
  {
    notionIds: ["quad_parabole", "quad_sommet_axe", "quad_variations"],
    discipline: "Physique",
    situation:
  ...
  {
    notionIds: ["quad_racines_signe", "quad_sommet_axe", "quad_variations"],
    discipline: "Économie",
    situation:
  ...
  {
    notionIds: ["quad_sommet_axe", "quad_variations"],
    discipline: "Sciences de la vie",
    situation:
  ...
  {
    notionIds: ["expo_suite_geometrique", "expo_modeliser", "expo_seuil"],
    discipline: "Sciences de la vie",
    situation:
  ...
  {
    notionIds: ["expo_suite_geometrique", "expo_taux_moyen", "expo_modeliser", "expo_seuil"],
    discipline: "Éducation économique, financière et budgétaire",
    situation:
  ...
  {
    notionIds: ["expo_modeliser", "expo_seuil", "lin_modeliser", "lin_seuil"],
  ...
  {
    notionIds: ["expo_modeliser", "expo_seuil"],
  ...
  {
    notionIds: ["expo_modeliser", "expo_seuil", "expo_taux_moyen"],
    discipline: "Sciences de la vie",
    situation:
  ...
  {
    notionIds: ["der_graphique", "der_nombre_derive", "der_signe", "der_variations"],
    discipline: "Sciences de la vie",
    situation:
  ...
  {
    notionIds: ["der_graphique", "der_nombre_derive"],
    discipline: "Physique",
    situation:
  ...
  {
    notionIds: ["der_polynome", "der_signe", "der_variations"],
    discipline: "Économie",
    situation:
