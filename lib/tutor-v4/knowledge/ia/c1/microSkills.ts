...
export const microSkills: MicroSkillSource[] = [
  ...
  { id: "ia_c1_risques_regles", label: "Je sais prevoir les risques et proposer des regles de securite.", notionId: "ia_c1_responsabilite_pitch", prerequis: ["ia_c1_criteres_reussite"] },
  { id: "ia_c1_tester_ameliorer", label: "Je sais tester une maquette et ameliorer le projet a partir des retours.", notionId: "ia_c1_responsabilite_pitch", prerequis: ["ia_c1_risques_regles"] },
