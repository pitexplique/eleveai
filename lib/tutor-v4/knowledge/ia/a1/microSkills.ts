...
export const microSkills: MicroSkillSource[] = [
  ...
  { id: "ia_a1_prediction", label: "Je comprends qu'une IA produit une reponse probable a partir de donnees et de modeles.", notionId: "ia_a1_definition", prerequis: ["ia_a1_distinguer_outils"] },
  ...
  { id: "ia_a1_vocabulaire_base", label: "Je connais les mots donnee, modele, prompt, biais et hallucination.", notionId: "ia_a1_usages_limites", prerequis: ["ia_a1_erreur_possible"] },
];
