...
export const reelsIntervallesBank: TutorBankItemV4[] = [
  ...
  {
    kind: "fixed",
    id: "seconde_reels_ensembles_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "reels_ensembles",
    difficulty: 3,
    theme: "neutral",
    text: "Pourquoi $\\sqrt{2}$ est-il un nombre irrationnel ?",
    format: "qcm",
    choices: [
      "Parce qu'il ne peut pas s'écrire comme quotient de deux entiers",
      "Parce qu'il est négatif",
      "Parce qu'il est plus grand que $1$",
      "Parce que $2$ est pair",
    ],
    expected: ["Parce qu'il ne peut pas s'écrire comme quotient de deux entiers"],
    comparator: "mcq_exact",
    hint: "Un rationnel est un quotient de deux entiers.",
    explanation: exp(
      "Un nombre irrationnel n'est pas un quotient de deux entiers.",
      "On se demande si $\\sqrt{2}$ peut s'écrire $\\dfrac{p}{q}$.",
      "On démontre que c'est impossible : $\\sqrt{2}$ est irrationnel.",
      "Car $\\sqrt{2}$ ne peut pas s'écrire comme quotient de deux entiers."
    ),
    tags: ["seconde", "maths", "reels", "ensembles", "raisonnement", "qcm"],
  },

  {
    kind: "fixed",
    id: "seconde_reels_ensembles_raison_2",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "reels_ensembles",
    difficulty: 2,
    theme: "neutral",
    text: "Quelle est la différence entre un nombre rationnel et un nombre irrationnel ?",
    format: "qcm",
    choices: [
      "Un rationnel s'écrit comme quotient de deux entiers, pas un irrationnel",
      "Un rationnel est toujours positif",
      "Un irrationnel est toujours plus grand",
      "Il n'y a aucune différence",
    ],
    expected: ["Un rationnel s'écrit comme quotient de deux entiers, pas un irrationnel"],
    comparator: "mcq_exact",
    hint: "Pense à la forme $\\dfrac{p}{q}$.",
    explanation: exp(
      "La distinction repose sur l'écriture en fraction d'entiers.",
      "Un rationnel : $\\dfrac{p}{q}$ avec $p, q$ entiers ; un irrationnel : impossible.",
      "Exemples : $\\dfrac{3}{4}$ est rationnel, $\\pi$ est irrationnel.",
      "Un rationnel s'écrit comme quotient de deux entiers, pas un irrationnel."
    ),
    tags: ["seconde", "maths", "reels", "ensembles", "raisonnement", "qcm"],
  },
  ...
  {
    kind: "fixed",
    id: "seconde_droite_graduee_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "reels_droite_graduee",
    difficulty: 2,
    theme: "neutral",
    text: "À quoi sert la droite graduée pour les nombres réels ?",
    format: "qcm",
    choices: [
      "À associer à chaque point un unique nombre réel (et inversement)",
      "À mesurer des angles",
      "À tracer des fonctions",
      "À calculer des aires",
    ],
    expected: ["À associer à chaque point un unique nombre réel (et inversement)"],
    comparator: "mcq_exact",
    hint: "Chaque point a une abscisse, chaque réel a un point.",
    explanation: exp(
      "La droite graduée fait le lien entre points et nombres.",
      "À chaque réel correspond un unique point, et réciproquement.",
      "C'est la représentation géométrique des réels.",
      "Elle associe à chaque point un unique nombre réel."
    ),
    tags: ["seconde", "maths", "reels", "droite_graduee", "raisonnement", "qcm"],
  },

  {
    kind: "fixed",
    id: "seconde_intervalle_representer_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "intervalle_representer",
    difficulty: 2,
    theme: "neutral",
    text: "À quoi sert la notation en intervalle ?",
    format: "qcm",
    choices: [
      "À décrire un ensemble de nombres vérifiant une condition",
      "À écrire une fraction",
      "À calculer une moyenne",
      "À résoudre un triangle",
    ],
    expected: ["À décrire un ensemble de nombres vérifiant une condition"],
    comparator: "mcq_exact",
    hint: "$[2\\,;5[$ décrit tous les $x$ tels que $2 \\le x < 5$.",
    explanation: exp(
      "Un intervalle est une écriture compacte d'un ensemble de réels.",
      "Il regroupe tous les nombres entre deux bornes.",
      "Par exemple $[2\\,;5[$ = tous les $x$ tels que $2 \\le x < 5$.",
      "Il sert à décrire un ensemble de nombres vérifiant une condition."
    ),
    tags: ["seconde", "maths", "reels", "intervalle", "raisonnement", "qcm"],
  },

  {
    kind: "fixed",
    id: "seconde_intervalle_appartenance_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "intervalle_appartenance",
    difficulty: 2,
    theme: "neutral",
    text: "Comment vérifier qu'un nombre $x$ appartient à l'intervalle $[a\\,;b[$ ?",
    format: "qcm",
    choices: [
      "Vérifier que $a \\le x < b$",
      "Vérifier que $x > a + b$",
      "Vérifier que $x$ est positif",
      "Vérifier que $x$ est un entier",
    ],
    expected: ["Vérifier que $a \\le x < b$"],
    comparator: "mcq_exact",
    hint: "Crochet fermé en $a$, ouvert en $b$.",
    explanation: exp(
      "L'appartenance se vérifie en comparant $x$ aux deux bornes.",
      "$[a\\,;b[$ : $a$ inclus, $b$ exclu.",
      "Donc $x$ y appartient si $a \\le x < b$.",
      "On vérifie que $a \\le x < b$."
    ),
    tags: ["seconde", "maths", "reels", "appartenance", "raisonnement", "qcm"],
  },

  {
    kind: "fixed",
    id: "seconde_valeur_absolue_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "valeur_absolue_distance",
    difficulty: 2,
    theme: "neutral",
    text: "Que représente $|x - a|$ ?",
    format: "qcm",
    choices: [
      "La distance entre $x$ et $a$",
      "La somme de $x$ et $a$",
      "Le produit de $x$ et $a$",
      "La moyenne de $x$ et $a$",
    ],
    expected: ["La distance entre $x$ et $a$"],
    comparator: "mcq_exact",
    hint: "La valeur absolue d'une différence mesure un écart.",
    explanation: exp(
      "$|x - a|$ mesure l'écart entre deux nombres sur la droite réelle.",
      "On interprète la valeur absolue d'une différence comme une distance.",
      "Peu importe l'ordre : $|x - a| = |a - x|$.",
      "$|x - a|$ représente la distance entre $x$ et $a$."
    ),
    tags: ["seconde", "maths", "reels", "valeur_absolue", "raisonnement", "qcm"],
  },

  {
    kind: "fixed",
    id: "seconde_valeur_absolue_raison_2",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "valeur_absolue_distance",
    difficulty: 3,
    theme: "neutral",
    text: "Pourquoi la valeur absolue d'un nombre est-elle toujours positive ou nulle ?",
    format: "qcm",
    choices: [
      "Parce qu'elle représente une distance",
      "Parce qu'on enlève toujours $1$",
      "Parce que les nombres sont positifs",
      "Parce qu'on arrondit",
    ],
    expected: ["Parce qu'elle représente une distance"],
    comparator: "mcq_exact",
    hint: "Une distance ne peut pas être négative.",
    explanation: exp(
      "La valeur absolue mesure une distance à $0$.",
      "Or une distance est toujours positive ou nulle.",
      "Donc $|x| \\ge 0$ pour tout réel $x$.",
      "Car elle représente une distance."
    ),
    tags: ["seconde", "maths", "reels", "valeur_absolue", "raisonnement", "qcm"],
  },
  ...
  {
    kind: "fixed",
    id: "seconde_reels_encadrement_raison_1",
    niveau: "seconde",
    matiere: "maths",
    notionId: "reels_intervalles",
    microId: "reels_encadrement",
    difficulty: 2,
    theme: "neutral",
    text: "À quoi sert un encadrement décimal d'un nombre réel ?",
    format: "qcm",
    choices: [
      "À donner une valeur approchée entre deux bornes connues",
      "À le rendre entier",
      "À le multiplier par $10$",
      "À le transformer en fraction",
    ],
    expected: ["À donner une valeur approchée entre deux bornes connues"],
    comparator: "mcq_exact",
    hint: "Ex. $1{,}4 < \\sqrt{2} < 1{,}5$.",
    explanation: exp(
      "Encadrer, c'est situer un nombre entre deux décimaux proches.",
      "Cela donne une valeur approchée avec une précision choisie.",
      "Ex. $1{,}41 < \\sqrt{2} < 1{,}42$ encadre $\\sqrt{2}$ au centième.",
