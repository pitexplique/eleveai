// Banque du coach IA — palier novice et indépendant (collège).
//
...
export const iaPixCollegeQuestionBank: TutorBankItemV4[] =
  convertirQuestionsPix("college");

export function getIaPixCollegeQuestionBank(args?: {
  notionId?: string | null;
  microId?: string | null;
}): TutorBankItemV4[] {
  let bank = iaPixCollegeQuestionBank;
