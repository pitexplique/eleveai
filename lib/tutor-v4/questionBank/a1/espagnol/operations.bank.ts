...
const WORDS = [
  { slug: "mas",       es: "más",       fr: "plus"       },
  { slug: "menos",     es: "menos",     fr: "moins"      },
  { slug: "por",       es: "por",       fr: "fois (×)"   },
  { slug: "dividido",  es: "dividido",  fr: "divisé par" },
  { slug: "igual",     es: "igual",     fr: "égal"       },
  { slug: "suma",      es: "suma",      fr: "addition"   },
  { slug: "resta",     es: "resta",     fr: "soustraction"},
  { slug: "multiplicacion", es: "multiplicación", fr: "multiplication" },
  { slug: "division",  es: "división",  fr: "division"   },
  { slug: "resultado", es: "resultado", fr: "résultat"   },
] as const;
