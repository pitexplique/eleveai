...
« ${abimee} »`,
  ...
  },
  {
    ...
    format: "qcm",
    choices: [
      "Le point d'interrogation : c'est une question",
      "La majuscule",
      "Un verbe",
      "Rien, la phrase est correcte",
    ],
    expected: ["Le point d'interrogation : c'est une question"],
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    choices: [
      ...
      "Le chien disparait",
      "Il faut enlever le point aussi",
    ],
    expected: ["La phrase marche encore, mais on sait moins de choses"],
    comparator: "mcq_exact",
