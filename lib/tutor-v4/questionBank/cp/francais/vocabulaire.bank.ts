...
export const vocabulaireBank: TutorBankItemV4[] = [
  ...
  ========================================================= */
  {
    ...
    format: "qcm",
    choices: [
      "un endroit sans arbres au milieu des arbres",
      "un très grand arbre au bord du chemin",
      "un chemin de montagne bordé d'herbe",
      "un petit animal qui vit dans la forêt",
    ],
    expected: ["un endroit sans arbres au milieu des arbres"],
  ...
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        format: "qcm" as const,
        choices: [
          "Non : leur sens n'a rien à voir",
          "Oui : ils commencent de la même façon",
          "Oui : ils se prononcent presque pareil",
          "On ne peut pas le savoir sans dictionnaire",
        ],
        expected: ["Non : leur sens n'a rien à voir"],
        comparator: "mcq_exact" as const,
        explanation: exp(
