...
export const probabilitesBank: TutorBankItemV4[] = [
...

  {
    ...
    difficulty: 4,
    theme: "neutral",
    text: "Un élève dit : “J’ai fait tourner la roue et j’ai eu Bleu, donc Bleu était le plus probable.” A-t-il raison ?",
    format: "qcm",
    choices: ["non", "oui"],
    expected: ["non"],
    comparator: "mcq_exact",
    hint: "Un seul tour suffit-il à décider ce qui est le plus probable ?",
    explanation:
      "Non. Le résultat d’un tour ne dit rien sur les chances de départ : le moins probable sort parfois, c’est même pour ça qu’on parle de hasard. Ce qui décide, c’est la place occupée sur la roue — et Rouge en occupe le plus.",
...

  {
    ...
    difficulty: 5,
    theme: "neutral",
    text: "Que faudrait-il changer sur cette roue pour que Rouge et Bleu aient exactement autant de chances ?",
    format: "open",
    expected: ["même", "meme", "place", "égale", "egale", "part", "taille", "pareil"],
    comparator: "contains_keyword",
    hint: "Regarde la place que chaque couleur occupe sur le disque.",
    explanation:
      "Il faudrait que Rouge et Bleu occupent la même place sur la roue. Sur un disque, ce n’est pas le nombre de parts qui compte, mais la surface : deux couleurs ont autant de chances quand elles couvrent la même portion du tour.",
