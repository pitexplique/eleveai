...
export const figuresPlanesBank: TutorBankItemV4[] = [
...

  {
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Sur cette figure, qu’ont en commun tous les points du contour bleu ?",
    format: "qcm",
    choices: [
      "ils sont tous à la même distance du centre O",
      "ils sont tous alignés",
      "ils sont tous à la même distance du bord de la feuille",
      "ils forment tous un angle droit avec O",
    ],
    expected: ["ils sont tous à la même distance du centre O"],
    comparator: "mcq_exact",
    hint: "C’est ce qui définit un cercle, et ce qui permet de le tracer au compas.",
    explanation:
      "Tous les points du cercle sont à la même distance du centre O : cette distance, c’est le rayon. C’est exactement ce que fait le compas — sa pointe reste sur O, son écartement ne change pas.",
...

  {
    ...
    difficulty: 4,
    theme: "neutral",
    text: "Un triangle isocèle est-il toujours équilatéral ?",
    format: "qcm",
    choices: ["non", "oui"],
    expected: ["non"],
    comparator: "mcq_exact",
    hint: "Un triangle isocèle demande DEUX côtés égaux. Le troisième, lui, est libre.",
    explanation:
      "Non, et c’est le sens qui trompe. Un triangle isocèle a deux côtés égaux, mais le troisième peut être plus court ou plus long. Un triangle équilatéral, lui, a ses TROIS côtés égaux : il est donc isocèle, mais l’inverse n’est pas vrai.",
