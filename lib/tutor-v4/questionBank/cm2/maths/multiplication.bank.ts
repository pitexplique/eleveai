...
export const multiplicationBank: TutorBankItemV4[] = [
...

  {
    ...
    difficulty: 2,
    theme: "reunion",
    hint: "Chaque paquet contient le même nombre d’objets.",
    tags: ["cm2", "multiplication", "table", "reunion", "template"],
    generate: () => {
      const paquets = randomChoice([3, 4, 5, 6, 7, 8]);
      const fruits = randomChoice([4, 5, 6, 7, 8, 9]);
      const total = paquets * fruits;

      return {
        text: `Au marché de Saint-Pierre, il y a ${paquets} paniers avec ${fruits} fruits dans chaque panier. Combien y a-t-il de fruits au total ?`,
        format: "short",
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: exp(
          ...
          `${tens} × ${factor} = ${tens * factor} et ${units} × ${factor} = ${units * factor}. Donc ${tens * factor} + ${units * factor} = ${result}.`,
          `La réponse est ${result}.`
        ),
      };
    },
...

  {
    ...
    generate: () => {
      const n = randomChoice([4, 8, 12, 16, 20, 24, 28, 32]);
      const result = n * 25;

      return {
        text: `Calcule mentalement : ${n} × 25`,
        format: "short",
        expected: [String(result)],
        comparator: "number_equal",
        explanation: exp(
          "Multiplier par 25 peut se faire en utilisant 100.",
          "On multiplie par 100 puis on divise par 4.",
          `${n} × 100 = ${n * 100}, puis ${n * 100} ÷ 4 = ${result}.`,
          `Donc ${n} × 25 = ${result}.`
        ),
      };
    },
...

  {
    ...
    tags: ["cm2", "multiplication", "mental", "reunion", "template"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "posee", "erreur", "verification", "template", "canvas"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "posee", "probleme", "reunion", "template", "canvas"],
    generate: () => {
...

  {
    ...
    explanation: exp(
      "Multiplier par 10, 100 ou 1 000 permet de changer le rang des chiffres.",
...

  {
    ...
    explanation: exp(
      "Multiplier par 100 change le rang des chiffres.",
...

  {
    ...
    explanation: exp(
      "Multiplier par 1 000 change fortement le rang des chiffres.",
...

  {
    ...
    generate: () => {
      ...
      return {
        text: `Quel est le résultat de ${n} × ${factor === 1000 ? "1 000" : factor} ?`,
        format: "qcm",
...

  {
    ...
    tags: ["cm2", "multiplication", "puissance_dix", "reunion", "template"],
    generate: () => {
...

  {
    ...
    generate: () => {
      ...
      return {
        text: `Un élève affirme que ${n} × ${factor === 1000 ? "1 000" : factor} = ${wrong}. A-t-il raison ?`,
        format: "qcm",
        choices: ["oui", "non"],
        expected: ["non"],
        comparator: "mcq_exact",
...

  {
    ...
    tags: ["cm2", "multiplication", "probleme", "reunion", "marche", "template"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "probleme", "reunion", "dechet", "template"],
    generate: () => {
      const groupes = randomChoice([3, 4, 5, 6, 8]);
      const dechets = randomChoice([10, 12, 15, 20, 25]);
...

  {
    ...
    tags: ["cm2", "multiplication", "probleme", "jeu_video", "pieces", "template"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "probleme", "reunion", "canvas", "template"],
    generate: () => {
      const sacs = randomChoice([12, 15, 18, 24]);
      const fruits = randomChoice([6, 8, 9]);
      const total = sacs * fruits;
...

  {
    ...
    tags: ["cm2", "multiplication", "defi", "tresor", "pieces", "template"],
    generate: () => {
      const coffres = randomChoice([3, 4, 5, 6, 8]);
...

  {
    ...
    tags: ["cm2", "multiplication", "defi", "margouillat", "reunion", "template"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "defi", "reunion", "deux_etapes", "template"],
    generate: () => {
...

  {
    ...
    tags: ["cm2", "multiplication", "defi", "ecologie", "reunion", "deux_etapes", "template"],
    generate: () => {
