...
export const fractionsBank: TutorBankItemV4[] = [
  ...
  // =========================
  {
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Quel est l’inverse de 3/7 ?",
    format: "short",
    expected: ["7/3"],
    comparator: "fraction_decimal_equivalent",
    hint: "On échange numérateur et dénominateur.",
    explanation: expl("L’inverse de 3/7 est 7/3."),
    tags: ["fraction_nombre", "inverse"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Quel est l’inverse de 5 ?",
    format: "short",
    expected: ["1/5"],
    comparator: "fraction_decimal_equivalent",
    hint: "On peut écrire 5 = 5/1.",
    explanation: expl("5 = 5/1, donc son inverse est 1/5."),
    tags: ["fraction_nombre", "inverse"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Quel est l’inverse de 1/8 ?",
    format: "short",
    expected: ["8", "8/1"],
    comparator: "fraction_decimal_equivalent",
    hint: "On retourne la fraction.",
    explanation: expl("L’inverse de 1/8 est 8/1 = 8."),
    tags: ["fraction_nombre", "inverse"],
  },
  {
    kind: "fixed",
    id: "fraction_inverse_qcm_2",
    niveau: "5e",
    matiere: "maths",
    notionId: "fraction_calcul",
    microId: "fraction_inverse",
    difficulty: 3,
    theme: "neutral",
    text: "Le produit d’une fraction par son inverse vaut toujours :",
    format: "qcm",
    choices: ["1", "0", "2", "la fraction de départ"],
    expected: ["1"],
    comparator: "mcq_exact",
    hint: "Essaie 2/3 × 3/2.",
    explanation: expl("Une fraction multipliée par son inverse donne toujours 1 (ex. 2/3 × 3/2 = 6/6 = 1)."),
    tags: ["fraction_nombre", "inverse", "qcm"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Explique comment trouver l’inverse d’une fraction.",
    format: "open",
    expected: ["échange", "numérateur", "dénominateur"],
    comparator: "contains_keyword",
    hint: "On retourne la fraction.",
    explanation: expl("Pour trouver l’inverse d’une fraction, on échange le numérateur et le dénominateur."),
  ...
  },
  {
    ...
    difficulty: 2,
    theme: "neutral",
    hint: "Échange le haut et le bas.",
    tags: ["fraction_nombre", "inverse", "template"],
    generate: () => {
      const n = randomChoice([2, 3, 4, 5, 7]);
      const d = randomChoice([3, 5, 6, 8, 9]);
      return {
        text: `Quel est l’inverse de ${n}/${d} ?`,
        format: "short",
        expected: [fractionStr(d, n)],
        comparator: "fraction_decimal_equivalent",
        explanation: expl(`On échange numérateur et dénominateur : l’inverse de ${n}/${d} est ${d}/${n}.`),
      };
    },
  },
  {
    ...
    difficulty: 3,
    theme: "neutral",
    hint: "Garde le signe, échange le haut et le bas.",
    tags: ["fraction_nombre", "inverse", "template", "signe"],
    generate: () => {
      const n = randomChoice([2, 3, 5, 7]);
      const d = randomChoice([4, 6, 9]);
      return {
        text: `Quel est l’inverse de -${n}/${d} ?`,
        format: "short",
        expected: [`-${d}/${n}`],
        comparator: "fraction_decimal_equivalent",
        explanation: expl(`On garde le signe et on échange numérateur et dénominateur : l’inverse de -${n}/${d} est -${d}/${n}.`),
      };
    },
  },
  ...
  // =========================
  {
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Diviser par 2/3, c’est multiplier par quelle fraction ?",
    format: "short",
    expected: ["3/2"],
    comparator: "fraction_decimal_equivalent",
    hint: "On multiplie par l’inverse.",
    explanation: expl("Diviser par 2/3, c’est multiplier par son inverse 3/2."),
    tags: ["fraction_nombre", "division"],
  },
  {
    kind: "fixed",
    ...
    expected: ["2", "2/1"],
    comparator: "fraction_decimal_equivalent",
    hint: "Multiplie 1/2 par 4/1.",
    explanation: expl("1/2 ÷ 1/4 = 1/2 × 4/1 = 4/2 = 2."),
    tags: ["fraction_nombre", "division"],
  },
  {
    kind: "fixed",
    id: "fraction_diviser_qcm_2",
    niveau: "5e",
    matiere: "maths",
    notionId: "fraction_calcul",
    microId: "fraction_diviser",
    difficulty: 3,
    theme: "neutral",
    text: "Quel est le résultat de 3/4 ÷ 3/8 ?",
    format: "qcm",
    choices: ["2", "1/2", "9/32", "3/2"],
    expected: ["2"],
    comparator: "mcq_exact",
    hint: "Multiplie 3/4 par 8/3.",
    explanation: expl("3/4 ÷ 3/8 = 3/4 × 8/3 = 24/12 = 2."),
    tags: ["fraction_nombre", "division", "qcm"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 3,
    theme: "neutral",
    text: "Explique la règle pour diviser par une fraction.",
    format: "open",
    expected: ["multiplie", "inverse"],
    comparator: "contains_keyword",
    hint: "Pense à l’inverse.",
    explanation: expl("Diviser par une fraction, c’est multiplier par son inverse."),
    tags: ["fraction_nombre", "division", "open"],
  },
  {
    kind: "fixed",
    id: "fraction_diviser_fixed_5",
    niveau: "5e",
    matiere: "maths",
    notionId: "fraction_calcul",
    microId: "fraction_diviser",
    difficulty: 3,
    theme: "neutral",
    text: "Calcule 4/5 ÷ 2/5.",
    format: "short",
    expected: ["2", "2/1"],
    comparator: "fraction_decimal_equivalent",
    hint: "Multiplie 4/5 par 5/2.",
    explanation: expl("4/5 ÷ 2/5 = 4/5 × 5/2 = 20/10 = 2."),
    tags: ["fraction_nombre", "division"],
  },
  {
    kind: "template",
    ...
    difficulty: 4,
    theme: "neutral",
    hint: "Multiplie la première par l’inverse de la seconde.",
    tags: ["fraction_nombre", "division", "template"],
    generate: () => {
      const pairs = [
        [1, 2, 1, 4],
      ...
      return {
        ...
        expected: [fractionStr(simp.n, simp.d)],
        comparator: "fraction_decimal_equivalent",
        explanation: expl(`${n1}/${d1} ÷ ${n2}/${d2} = ${n1}/${d1} × ${d2}/${n2} = ${simp.n}/${simp.d}.`),
      };
    },
  },
