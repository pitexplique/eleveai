...
const IDEES: readonly Cas[] = [
  {
    ...
    faux: ["il fera 9 degrés au sommet", "il faut prendre un coupe-vent", "le car part du parking"],
  },
  {
    ...
    faux: ["il faut deux heures par mois", "on vous montrera tout", "le club existe déjà"],
  },
  {
    ...
    faux: ["les résultats existent déjà", "on peut écrire après lundi", "l'affichage se fait un lundi"],
  },
  {
    ...
    faux: ["le gymnase est fermé", "il pourrait pleuvoir", "les cours de sport existent"],
  },
  {
    ...
    droite: "les manuels doivent revenir avant vendredi, sous peine de facturation",
    faux: ["certains manuels sont perdus", "il faut signaler une perte", "les manuels coutent de l'argent"],
  },
  {
    ...
    faux: ["les inscriptions se font le lundi", "la cantine a un menu", "le menu change"],
  },
  {
    ...
    faux: ["vous serez en étude", "un contrôle était prévu", "le professeur enseigne l'anglais"],
  },
  {
    ...
    faux: ["le voyage coute 180 euros", "l'aide couvre la moitié", "il y a une date limite"],
  },
  {
    ...
    droite: "la classe doit désigner deux représentants disponibles trois mercredis",
    faux: ["le conseil se réunit le mercredi", "il faut être deux", "il y a trois réunions"],
  },
  {
    ...
    faux: ["le portail ouvre à 7 h 45", "il peut pleuvoir le matin", "des élèves arrivent en avance"],
  },
  {
    ...
    droite: "le partage du travail compte autant que ce qui est dit",
    faux: ["l'exposé se fait à deux", "chacun parle cinq minutes", "il y a une note"],
  },
  {
    ...
    droite: "le prêt continue pendant le déménagement, seuls les retours changent de lieu",
    faux: ["la bibliothèque déménage", "les vacances arrivent", "on peut emprunter"],
  },
  {
    ...
    droite: "les trois dernières places iront aux premiers qui s'inscriront",
    faux: ["il y a un atelier théâtre", "il reste trois places", "il faut s'inscrire"],
  },
  {
    ...
    faux: ["on peut rendre sur papier", "la messagerie existe", "il y a un devoir à rendre"],
  },
];
