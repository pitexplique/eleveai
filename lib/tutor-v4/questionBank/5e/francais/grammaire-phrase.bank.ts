...
const PONCTUATIONS: readonly Ponctuation[] = [
  {
    ...
    role: "elles isolent une relative qui ajoute un renseignement",
    faux: ["elles séparent les termes d'une longue énumération", "elles annoncent une explication de ce qui précède", "elles séparent le sujet de son verbe conjugué"],
  },
  {
    phrase: "Dans son sac, il avait un carnet, un crayon, une gourde et une carte.",
    signe: "les virgules du milieu de phrase",
    role: "elles séparent les termes d'une longue énumération",
  ...
  },
  {
    ...
    signe: "la virgule",
    role: "elle détache un complément placé en tête de phrase",
    faux: ["elle sépare le sujet de son verbe conjugué", "elle sépare deux propositions coordonnées", "elle annonce une énumération de termes"],
  },
  {
  ...
  },
  {
    ...
    faux: ["ils annoncent une énumération de plusieurs termes", "ils donnent l'explication de ce qui vient d'être dit", "ils signalent le titre d'une œuvre citée"],
  },
  {
    phrase: "La pluie avait cessé ; le sentier restait glissant.",
    signe: "le point-virgule",
    role: "il relie deux propositions dont le sens se tient",
    faux: ["il annonce l'explication de ce qui vient d'être dit", "il sépare les termes d'une énumération un peu longue", "il détache un complément placé en tête de phrase"],
  },
  {
...
export const grammairePhrase5eBank: TutorBankItemV4[] = [
  ...
  },
  {
    ...
    format: "qcm",
    choices: [
      "l'exclamative est une FORME : le type reste déclaratif ou impératif",
      "rien : « exclamatif » est bien le quatrième type, à côté des trois autres",
      "il aurait fallu écrire « de type interrogatif », qui serait plus juste",
      "une phrase ne peut pas être exclamative si elle se termine par un point",
    ],
    expected: [
      "l'exclamative est une FORME : le type reste déclaratif ou impératif",
    ],
