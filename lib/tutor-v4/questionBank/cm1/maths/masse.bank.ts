...
export const masseBank: TutorBankItemV4[] = [
  {
    kind: "fixed",
    id: "cm1_masse_comparer_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "masse",
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Qu'est-ce qui est le plus lourd : 1 kg ou 500 g ?",
    format: "qcm",
    choices: ["1 kg","500 g","c'est pareil","on ne peut pas savoir"],
    expected: ["1 kg"],
    comparator: "mcq_exact",
    hint: "Mets la même unité avant de comparer.",
    explanation: "1 kg = 1000 g, et 1000 g est plus lourd que 500 g.",
    tags: ["cm1","masse","masse_comparer","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_masse_comparer_fixed_g2",
    niveau: "cm1",
    matiere: "maths",
    notionId: "masse",
    microId: "masse_comparer",
    difficulty: 2,
    theme: "neutral",
    text: "Parmi 200 g, 1 kg et 750 g, lequel est le plus léger ?",
    format: "qcm",
    choices: ["200 g","750 g","1 kg","ils sont égaux"],
    expected: ["200 g"],
    comparator: "mcq_exact",
    hint: "1 kg = 1000 g.",
    explanation: "En grammes : 200, 750 et 1000. Le plus petit est 200 g.",
    tags: ["cm1","masse","masse_comparer","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_masse_estimer_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "masse",
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Quelle masse est la plus raisonnable pour une pomme ?",
    format: "qcm",
    choices: ["150 g","15 kg","1 g","50 kg"],
    expected: ["150 g"],
    comparator: "mcq_exact",
    hint: "Compare avec un objet que tu connais.",
    explanation: "Une pomme pèse environ 150 g.",
    tags: ["cm1","masse","masse_estimer","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_masse_defi_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "masse",
    microId: "masse_defi",
    difficulty: 3,
    theme: "reunion",
    text: "Un sac contient 3 ananas de 1 kg chacun et 500 g de letchis. Quelle est la masse totale ?",
    format: "qcm",
    choices: ["3 kg 500 g","4 kg","3 kg","2 kg 500 g"],
    expected: ["3 kg 500 g"],
    comparator: "mcq_exact",
    hint: "Additionne les ananas, puis ajoute les letchis.",
    explanation: "3 × 1 kg = 3 kg, plus 500 g : la masse totale est 3 kg 500 g.",
    tags: ["cm1","masse","masse_defi","guide","qcm"],
  },
