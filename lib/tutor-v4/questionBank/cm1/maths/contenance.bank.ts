...
export const contenanceBank: TutorBankItemV4[] = [
  {
    kind: "fixed",
    id: "cm1_contenance_comparer_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "contenance",
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Qu'est-ce qui contient le plus : 1 L ou 500 mL ?",
    format: "qcm",
    choices: ["1 L","500 mL","c'est pareil","on ne peut pas savoir"],
    expected: ["1 L"],
    comparator: "mcq_exact",
    hint: "Mets la même unité avant de comparer.",
    explanation: "1 L = 1000 mL, et 1000 mL est plus que 500 mL.",
    tags: ["cm1","contenance","contenance_comparer","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_contenance_convertir_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "contenance",
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Combien de millilitres y a-t-il dans 2 L ?",
    format: "qcm",
    choices: ["2000 mL","200 mL","20 mL","2 mL"],
    expected: ["2000 mL"],
    comparator: "mcq_exact",
    hint: "1 L = 1000 mL.",
    explanation: "2 L = 2 × 1000 = 2000 mL.",
    tags: ["cm1","contenance","contenance_convertir","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_contenance_convertir_fixed_g2",
    niveau: "cm1",
    matiere: "maths",
    notionId: "contenance",
    microId: "contenance_convertir",
    difficulty: 2,
    theme: "neutral",
    text: "Combien de litres font 3000 mL ?",
    format: "qcm",
    choices: ["3 L","30 L","300 L","0,3 L"],
    expected: ["3 L"],
    comparator: "mcq_exact",
    hint: "On divise par 1000 pour aller vers le litre.",
    explanation: "3000 mL ÷ 1000 = 3 L.",
    tags: ["cm1","contenance","contenance_convertir","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_contenance_estimer_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "contenance",
    ...
    difficulty: 1,
    theme: "neutral",
    text: "Quelle contenance est la plus raisonnable pour une gourde d'élève ?",
    format: "qcm",
    choices: ["500 mL","50 L","5 mL","20 L"],
    expected: ["500 mL"],
    comparator: "mcq_exact",
    hint: "Une gourde tient dans un cartable.",
    explanation: "Une gourde contient environ un demi-litre, soit 500 mL.",
    tags: ["cm1","contenance","contenance_estimer","guide","qcm"],
  },
  {
    kind: "fixed",
    id: "cm1_contenance_defi_fixed_g1",
    niveau: "cm1",
    matiere: "maths",
    notionId: "contenance",
    ...
    difficulty: 3,
    theme: "neutral",
    text: "Une bouteille de 1 L 500 mL remplit combien de verres de 250 mL ?",
    format: "qcm",
    choices: ["6 verres","5 verres","4 verres","15 verres"],
    expected: ["6 verres"],
    comparator: "mcq_exact",
    hint: "Convertis d'abord tout en millilitres.",
    explanation: "1 L 500 mL = 1500 mL. 1500 ÷ 250 = 6 verres.",
    tags: ["cm1","contenance","contenance_defi","guide","qcm"],
  },
