...
export const equationsBank: TutorBankItemV4[] = [
  ...
  {
    kind: "fixed",
    id: "equation_resoudre_distributivite_fixed_1",
    niveau: "4e",
    matiere: "maths",
    notionId: "equations",
  ...
  {
    kind: "fixed",
    id: "equation_resoudre_distributivite_fixed_2",
    niveau: "4e",
    matiere: "maths",
    notionId: "equations",
    microId: "equation_resoudre_distributivite",
  ...
  {
    kind: "template",
    id: "equation_resoudre_distributivite_tpl_1",
    niveau: "4e",
    matiere: "maths",
    notionId: "equations",
    microId: "equation_resoudre_distributivite",
    ...
    tags: ["equation", "distributivite", "template"],
    generate: () => {
