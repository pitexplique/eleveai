...
const AMOUR: readonly Cas[] = [
  { gauche: "Le poète s'adresse directement à celle qu'il aime et lui avoue, en face, ce qu'il n'osait pas dire.", droite: "la déclaration : on parle à l'être aimé pour lui dire ce qu'on éprouve" },
  { gauche: "Toute la lettre tend vers une phrase, retardée jusqu'à la fin : « je vous aime »." , droite: "la déclaration : on parle à l'être aimé pour lui dire ce qu'on éprouve" },
  { gauche: "Le personnage répète qu'il va se taire, et il parle pendant vingt vers pour dire son amour.", droite: "la déclaration : on parle à l'être aimé pour lui dire ce qu'on éprouve" },

  { gauche: "Le poème énumère les cheveux, le front, les yeux, la main, et célèbre chaque détail l'un après l'autre.", droite: "l'éloge : on célèbre la beauté de l'aimé, détail par détail" },
  { gauche: "Chaque strophe compare une partie du visage à une chose précieuse.", droite: "l'éloge : on célèbre la beauté de l'aimé, détail par détail" },
  { gauche: "Le texte ne raconte rien : il décrit celle qu'il aime, et rien d'autre.", droite: "l'éloge : on célèbre la beauté de l'aimé, détail par détail" },

  { gauche: "Le poète pleure celle qui est morte, et le poème entier tient dans ce deuil.", droite: "la plainte : on dit la douleur d'un amour perdu ou impossible" },
  { gauche: "Le texte revient sur un bonheur ancien, et chaque souvenir rend l'absence plus lourde.", droite: "la plainte : on dit la douleur d'un amour perdu ou impossible" },
  { gauche: "Le personnage sait que cet amour ne se réalisera jamais, et il le dit sans espoir.", droite: "la plainte : on dit la douleur d'un amour perdu ou impossible" },

  { gauche: "Le poète, éconduit, retourne son amour en reproche et accuse celle qui l'a quitté.", droite: "le dépit : l'amour blessé se retourne en reproche" },
  { gauche: "Le texte annonce qu'il ne parlera plus d'elle, puis lui reproche tout pendant trente vers.", droite: "le dépit : l'amour blessé se retourne en reproche" },
  { gauche: "Le personnage jure qu'il est guéri, et sa colère prouve le contraire.", droite: "le dépit : l'amour blessé se retourne en reproche" },

  { gauche: "L'aimé est parti ; le poème ne parle que de la chambre vide et du temps qui ne passe pas.", droite: "l'attente : c'est le manque, et non l'aimé, que le texte met au centre" },
  { gauche: "Le texte compte les jours qui restent avant le retour, et ne dit presque rien de l'autre.", droite: "l'attente : c'est le manque, et non l'aimé, que le texte met au centre" },
  { gauche: "Le personnage guette une lettre qui n'arrive pas, et c'est cette guette qui occupe tout le poème.", droite: "l'attente : c'est le manque, et non l'aimé, que le texte met au centre" },

  { gauche: "Le poète se moque des comparaisons habituelles — les yeux comme des soleils — et dit qu'il aimera sans elles.", droite: "l'ironie : on se moque des façons convenues de dire l'amour" },
  { gauche: "Le texte reprend tous les compliments attendus pour montrer qu'ils ne veulent plus rien dire.", droite: "l'ironie : on se moque des façons convenues de dire l'amour" },
  { gauche: "Le personnage refuse le langage des amoureux et prétend parler « comme on parle ».", droite: "l'ironie : on se moque des façons convenues de dire l'amour" },
];
...
const VALEURS: readonly Cas[] = [
  { gauche: "Le personnage aime quelqu'un que sa charge lui interdit d'épouser, et il doit choisir.", droite: "le devoir contre la passion : ce qu'on doit faire s'oppose à ce qu'on désire" },
  { gauche: "Un officier doit arrêter l'homme qu'il aime comme un frère.", droite: "le devoir contre la passion : ce qu'on doit faire s'oppose à ce qu'on désire" },
  { gauche: "L'héroïne renonce à partir parce qu'une promesse la retient.", droite: "le devoir contre la passion : ce qu'on doit faire s'oppose à ce qu'on désire" },

  { gauche: "Le jeune homme veut choisir son métier ; sa famille a décidé pour lui depuis toujours.", droite: "l'individu contre le groupe : une personne veut se décider seule, son milieu la retient" },
  { gauche: "La jeune fille refuse le mariage arrangé, et tout le village le lui reproche.", droite: "l'individu contre le groupe : une personne veut se décider seule, son milieu la retient" },
  { gauche: "Le personnage quitte sa province pour la capitale, contre l'avis de tous les siens.", droite: "l'individu contre le groupe : une personne veut se décider seule, son milieu la retient" },
  ...
  { gauche: "On ordonne au personnage quelque chose qu'il juge injuste, et il doit décider s'il obéit.", droite: "l'obéissance contre la conscience : un ordre s'oppose à ce qu'on croit juste" },
  { gauche: "Le serviteur reçoit une consigne qui va nuire à un innocent.", droite: "l'obéissance contre la conscience : un ordre s'oppose à ce qu'on croit juste" },
  { gauche: "Le personnage applique la règle, puis s'aperçoit qu'elle écrase quelqu'un.", droite: "l'obéissance contre la conscience : un ordre s'oppose à ce qu'on croit juste" },

  { gauche: "Le personnage peut s'élever socialement à condition de trahir celui qui l'a aidé.", droite: "l'ambition contre la fidélité : monter suppose de laisser quelqu'un derrière" },
  { gauche: "Une place est promise à qui acceptera de dénoncer un ancien ami.", droite: "l'ambition contre la fidélité : monter suppose de laisser quelqu'un derrière" },
  { gauche: "Le jeune arriviste renie ses origines pour être reçu dans un salon.", droite: "l'ambition contre la fidélité : monter suppose de laisser quelqu'un derrière" },
...
const FICTION: readonly Cas[] = [
  ...
  { gauche: "Le personnage semble condamné d'avance par son milieu et par ce qu'il tient de ses parents.", droite: "le naturalisme : expliquer l'homme par son milieu et son hérédité, comme une expérience" },
  { gauche: "Le roman se présente comme l'étude d'une famille sur plusieurs générations.", droite: "le naturalisme : expliquer l'homme par son milieu et son hérédité, comme une expérience" },
  { gauche: "L'auteur observe son personnage comme un savant observerait un cas.", droite: "le naturalisme : expliquer l'homme par son milieu et son hérédité, comme une expérience" },
  ...
  { gauche: "Le récit imagine ce que deviendrait le monde si une machine découverte aujourd'hui allait jusqu'au bout.", droite: "l'anticipation : un monde possible, tiré d'une science poussée plus loin" },
  { gauche: "L'histoire se passe dans un siècle, et tout y découle d'une invention expliquée au lecteur.", droite: "l'anticipation : un monde possible, tiré d'une science poussée plus loin" },
  { gauche: "Le voyage décrit un engin qui n'existe pas encore, mais dont le fonctionnement est raisonné.", droite: "l'anticipation : un monde possible, tiré d'une science poussée plus loin" },
...
const INFO: readonly Cas[] = [
  { gauche: "« Un train est arrivé à 8 h 12 en gare de Saint-Denis. » Rien de plus.", droite: "un fait brut : ce qui s'est passé, vérifiable, sans mise en forme" },
  { gauche: "« Le vote a recueilli 143 voix pour et 96 contre. »", droite: "un fait brut : ce qui s'est passé, vérifiable, sans mise en forme" },
  { gauche: "« La température relevée hier à midi était de 31 degrés. »", droite: "un fait brut : ce qui s'est passé, vérifiable, sans mise en forme" },
  ...
  { gauche: "Avant de publier, le journaliste vérifie l'information auprès de trois personnes qui ne se connaissent pas.", droite: "le recoupement des sources : on ne publie pas une information qu'un seul témoin soutient" },
  { gauche: "La rédaction refuse une révélation tant qu'un second document ne la confirme pas.", droite: "le recoupement des sources : on ne publie pas une information qu'un seul témoin soutient" },
  { gauche: "L'article précise que deux services distincts ont confirmé le chiffre.", droite: "le recoupement des sources : on ne publie pas une information qu'un seul témoin soutient" },
  ...
  { gauche: "Les images sont vraies, mais leur ordre laisse croire que la seconde est la conséquence de la première.", droite: "le montage : chaque élément est exact, et leur assemblage suggère ce qui est faux" },
  { gauche: "Le reportage place la réponse avant la question, et le ton du témoin en paraît changé.", droite: "le montage : chaque élément est exact, et leur assemblage suggère ce qui est faux" },
  { gauche: "Deux séquences filmées à des mois d'intervalle se suivent sans que rien ne le signale.", droite: "le montage : chaque élément est exact, et leur assemblage suggère ce qui est faux" },
];
...
const VILLE: readonly Cas[] = [
  { gauche: "Le jeune homme arrive de sa province et regarde les vitrines comme on regarde un avenir.", droite: "la ville comme promesse : tout y semble possible à celui qui arrive" },
  { gauche: "Le texte énumère les métiers, les théâtres, les journaux : tout ce qu'on ne trouvait pas au village.", droite: "la ville comme promesse : tout y semble possible à celui qui arrive" },
  { gauche: "Le personnage se dit qu'ici, personne ne sait d'où il vient, et que tout peut recommencer.", droite: "la ville comme promesse : tout y semble possible à celui qui arrive" },
  ...
  { gauche: "Le personnage croise mille visages en une heure et n'échange pas un mot.", droite: "la solitude dans la foule : jamais autant de monde, jamais si seul" },
  { gauche: "Le texte insiste sur les fenêtres allumées, et sur celui qui les regarde d'en bas.", droite: "la solitude dans la foule : jamais autant de monde, jamais si seul" },
  { gauche: "Personne ne s'arrête quand l'homme tombe sur le trottoir.", droite: "la solitude dans la foule : jamais autant de monde, jamais si seul" },
  ...
  { gauche: "Les travaux ont fait disparaitre la rue où le narrateur avait grandi.", droite: "la ville qui change : elle efface un monde en même temps qu'elle en construit un autre" },
  { gauche: "Le texte compare ce qu'on voyait il y a vingt ans et ce qu'on voit aujourd'hui.", droite: "la ville qui change : elle efface un monde en même temps qu'elle en construit un autre" },
  { gauche: "Une avenue neuve traverse le quartier ancien, et le narrateur ne sait pas s'il faut s'en réjouir.", droite: "la ville qui change : elle efface un monde en même temps qu'elle en construit un autre" },
];
