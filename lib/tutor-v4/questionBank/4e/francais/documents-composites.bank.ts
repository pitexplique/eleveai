...
const NATURES: readonly Cas[] = [
  { gauche: "Une courbe montre la population de l'île année après année depuis 1960.", droite: "un graphique : il donne à voir une évolution" },
  { gauche: "Des lignes et des colonnes croisent les communes et leur nombre d'habitants.", droite: "un tableau : il croise deux séries de données" },
  { gauche: "Des flèches et des légendes expliquent comment se forme un cyclone.", droite: "un schéma : il explique un fonctionnement" },
  { gauche: "Un texte signé, daté, avec un titre accrocheur, raconte un fait de la semaine.", droite: "un article de presse : il informe sur un fait daté" },
  ...
  { gauche: "Un bâton par année compare les pluies tombées à Saint-Denis.", droite: "un graphique : il donne à voir une évolution" },
  { gauche: "Un texte explique ce qu'est le corail, sans raconter d'histoire ni donner d'avis.", droite: "un texte documentaire : il fait connaitre un sujet" },
  { gauche: "Des cases numérotées croisent les classes et leurs effectifs.", droite: "un tableau : il croise deux séries de données" },
  { gauche: "Un dessin légendé montre les couches d'un sol volcanique.", droite: "un schéma : il explique un fonctionnement" },
  { gauche: "Un texte du jour, avec le nom du journal et celui du journaliste.", droite: "un article de presse : il informe sur un fait daté" },
  ...
  { gauche: "Un texte décrit le cycle de vie de la tortue verte, avec des chiffres.", droite: "un texte documentaire : il fait connaitre un sujet" },
...
const SOURCES: readonly Cas[] = [
  { gauche: "Un document n'indique ni auteur ni date.", droite: "tu ne peux pas savoir s'il est encore juste : cherche la source avant de t'en servir" },
  { gauche: "Deux journaux donnent deux chiffres différents pour la même manifestation.", droite: "tu cites les deux et tu dis d'où vient chacun" },
  { gauche: "Un texte est publié par l'entreprise dont il parle.", droite: "il peut être exact, mais il n'est pas neutre : celui qui parle a un intérêt" },
  ...
  { gauche: "Un article commence par « selon une étude ».", droite: "tu cherches quelle étude : sans nom, la formule ne vaut rien" },
  { gauche: "Une photographie est publiée sans dire où ni quand elle a été prise.", droite: "elle peut illustrer autre chose que ce qu'on lui fait dire" },
...
const IMAGE: readonly Cas[] = [
  { gauche: "Le visage occupe toute l'image, on ne voit rien autour.", droite: "un gros plan : il impose l'émotion et supprime le décor" },
  { gauche: "On voit le personnage minuscule au milieu d'un paysage immense.", droite: "un plan large : il montre le personnage écrasé par ce qui l'entoure" },
  { gauche: "L'appareil regarde le personnage d'en bas.", droite: "une contre-plongée : elle grandit le sujet et le rend imposant" },
  { gauche: "L'appareil regarde le personnage d'en haut.", droite: "une plongée : elle écrase le sujet et le rend vulnérable" },
  { gauche: "Une seule zone est éclairée, tout le reste est dans l'ombre.", droite: "un éclairage contrasté : il désigne où regarder" },
  { gauche: "Le personnage est décentré, avec du vide devant lui.", droite: "un cadrage décentré : le vide fait attendre quelque chose" },
  { gauche: "On ne voit que des mains, en très gros.", droite: "un gros plan : il impose l'émotion et supprime le décor" },
  { gauche: "La foule s'étend jusqu'à l'horizon et personne ne se distingue.", droite: "un plan large : il montre le personnage écrasé par ce qui l'entoure" },
  ...
  { gauche: "La scène est vue depuis un toit, très au-dessus des gens.", droite: "une plongée : elle écrase le sujet et le rend vulnérable" },
  { gauche: "Une lumière crue vient de côté et creuse tous les reliefs.", droite: "un éclairage contrasté : il désigne où regarder" },
  ...
  { gauche: "L'image ne montre qu'un œil et une partie du front.", droite: "un gros plan : il impose l'émotion et supprime le décor" },
  { gauche: "On voit la barque comme un point sur toute la surface de la mer.", droite: "un plan large : il montre le personnage écrasé par ce qui l'entoure" },
];
...
const DESSIN: readonly Cas[] = [
  { gauche: "Le nez et les oreilles du personnage sont dix fois trop grands.", droite: "l'exagération d'un trait : elle rend le personnage reconnaissable et ridicule" },
  { gauche: "Une colombe tient un rameau dans son bec.", droite: "un symbole : un objet connu de tous remplace une idée" },
  { gauche: "D'un côté une table pleine, de l'autre une assiette vide.", droite: "le contraste : deux images côte à côte font apparaitre l'injustice" },
  { gauche: "Une phrase sous le dessin change complètement ce qu'on croyait voir.", droite: "la légende : elle donne au dessin son sens, et parfois le retourne" },
  { gauche: "Un ministre est dessiné en géant, les citoyens en fourmis.", droite: "l'exagération d'un trait : elle rend le personnage reconnaissable et ridicule" },
  { gauche: "Une balance apparait au-dessus d'un tribunal.", droite: "un symbole : un objet connu de tous remplace une idée" },
  { gauche: "À gauche un arbre en fleurs, à droite le même arbre mort.", droite: "le contraste : deux images côte à côte font apparaitre l'injustice" },
  { gauche: "Le titre du dessin dit l'inverse de ce que la scène montre.", droite: "la légende : elle donne au dessin son sens, et parfois le retourne" },
  { gauche: "Un personnage a une bouche démesurée et des yeux minuscules.", droite: "l'exagération d'un trait : elle rend le personnage reconnaissable et ridicule" },
  { gauche: "Une planète porte un pansement.", droite: "un symbole : un objet connu de tous remplace une idée" },
  { gauche: "Une file de voitures neuves passe devant un abribus effondré.", droite: "le contraste : deux images côte à côte font apparaitre l'injustice" },
  { gauche: "Sans la phrase écrite dessous, on ne comprendrait pas de quoi il s'agit.", droite: "la légende : elle donne au dessin son sens, et parfois le retourne" },
  { gauche: "Un drapeau en lambeaux flotte au-dessus d'un bâtiment intact.", droite: "un symbole : un objet connu de tous remplace une idée" },
  { gauche: "Le personnage est reconnaissable à une seule mèche de cheveux, énorme.", droite: "l'exagération d'un trait : elle rend le personnage reconnaissable et ridicule" },
];
...
const RAPPORTEES: readonly Cas[] = [
  ...
  { gauche: "Il s'arrêta net. Il ne pourrait jamais y arriver.", droite: "le discours indirect libre : ni guillemets ni subordonnée, la voix du personnage passe dans le récit" },
  ...
  { gauche: "Elle scruta la cour vide. Où étaient-ils donc passés ?", droite: "le discours indirect libre : ni guillemets ni subordonnée, la voix du personnage passe dans le récit" },
  ...
  { gauche: "Il referma le cahier. C'était fini pour cette année.", droite: "le discours indirect libre : ni guillemets ni subordonnée, la voix du personnage passe dans le récit" },
  ...
  { gauche: "Elle éteignit la lampe. Le lendemain, tout serait différent.", droite: "le discours indirect libre : ni guillemets ni subordonnée, la voix du personnage passe dans le récit" },
  { gauche: "Il grommela : « Personne ne m'écoute jamais. »", droite: "le discours direct : les paroles sont citées entre guillemets" },
  { gauche: "Il baissa les yeux. Personne ne l'écoutait jamais.", droite: "le discours indirect libre : ni guillemets ni subordonnée, la voix du personnage passe dans le récit" },
  ...
  { gauche: "Il annonça son départ à toute la classe.", droite: "le récit de paroles : on dit qu'il a parlé, sans rapporter ses mots" },
  { gauche: "Elle raconta longuement sa journée.", droite: "le récit de paroles : on dit qu'il a parlé, sans rapporter ses mots" },
  { gauche: "Ils discutèrent du voyage pendant une heure.", droite: "le récit de paroles : on dit qu'il a parlé, sans rapporter ses mots" },
];
