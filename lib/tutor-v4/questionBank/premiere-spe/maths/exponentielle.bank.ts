...
export const exponentielleBank: TutorBankItemV4[] = [
  ...
  },
  {
    ...
    difficulty: 3,
    theme: "neutral",
    text: "La suite définie par $u_n = e^{2n}$ est géométrique de raison :",
    format: "qcm",
    choices: ["$e^{2}$", "$2$", "$2e$", "$e^{2n}$"],
    expected: ["$e^{2}$"],
    comparator: "mcq_exact",
    hint: "Calcule le quotient $\\dfrac{u_{n+1}}{u_n}$.",
    explanation: exp(
      "La raison d'une suite géométrique est le quotient de deux termes consécutifs.",
      "$\\dfrac{u_{n+1}}{u_n} = \\dfrac{e^{2(n+1)}}{e^{2n}} = e^{2n+2-2n}$.",
      "$= e^{2}$, un nombre constant (environ $7{,}39$) : la suite est bien géométrique.",
      "La raison est $e^{2}$."
    ),
    tags: ["premiere", "maths", "exponentielle", "suite_geo", "qcm"],
  },
