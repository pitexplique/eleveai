...
export const geometrieRepereeBank: TutorBankItemV4[] = [
  ...
  },
  {
    ...
    difficulty: 4,
    theme: "neutral",
    text: "Quel est le projeté orthogonal du point $M(4 ; 3)$ sur l'axe des abscisses ?",
    format: "qcm",
    choices: ["$(4 ; 0)$", "$(0 ; 3)$", "$(3 ; 0)$", "$(0 ; 4)$"],
    expected: ["$(4 ; 0)$"],
    comparator: "mcq_exact",
    hint: "La perpendiculaire à l'axe des abscisses est verticale.",
    explanation: exp(
      "Projeter sur l'axe des abscisses, c'est descendre verticalement jusqu'à cet axe.",
      "La perpendiculaire à l'axe des abscisses passant par $M$ est la droite verticale d'équation $x = 4$.",
      "Elle coupe l'axe des abscisses ($y = 0$) au point $(4 ; 0)$ : l'abscisse est conservée, l'ordonnée devient nulle.",
      "Le projeté est $(4 ; 0)$ — et $(0 ; 3)$ serait le projeté sur l'axe des ordonnées."
    ),
    tags: ["premiere", "maths", "geometrie_reperee", "projete", "qcm"],
  },
  {
