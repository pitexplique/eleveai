...
export const masseBank: TutorBankItemV4[] = [
  ...
  },
  {
    ...
    difficulty: 2,
    theme: "neutral",
    text: "Avec quelle unité pèse-t-on une gomme ?",
    format: "qcm",
    choices: ["le gramme", "le kilogramme", "le mètre", "le litre"],
    expected: ["le gramme"],
    comparator: "mcq_exact",
    hint: "On la sent à peine dans la trousse.",
    explanation: exp(
      "On choisit l'unité qui donne un nombre facile à dire.",
      "On imagine l'objet dans la main, puis on essaie les deux unités de masse.",
      "Une gomme pèse environ 15 g. En kilogrammes, il faudrait écrire un nombre plus petit que 1, et on ne sait pas encore le faire au CE1.",
      "On pèse une gomme en grammes.",
    ),
    tags: ["ce1", "masse", "kg_g", "qcm"],
  },
  {
    kind: "fixed",
