...
export const fractionsBank: TutorBankItemV4[] = [
  ...
  // =========================
  {
    ...
    explanation: expectedExplanation(["1/4", "1 / 4", "0,25", "0.25"]),
  ...
  },
  {
    ...
    explanation: expectedExplanation(["1/2", "1 / 2", "0,5", "0.5"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    format: "short",
    expected: ["3/5", "3 / 5"],
    explanation: expectedExplanation(["3/5", "3 / 5"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    expected: ["1/5", "1 / 5"],
    explanation: expectedExplanation(["1/5", "1 / 5"]),
  ...
  },
  {
    ...
    expected: ["3/4", "3 / 4"],
    explanation: expectedExplanation(["3/4", "3 / 4"]),
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["2/8", "2 / 8", "1/4", "1 / 4", "0,25", "0.25"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    format: "short",
    expected: ["2", "deux"],
    explanation: expectedExplanation(["2", "deux"]),
    comparator: "contains_keyword",
  ...
  },
  {
    ...
    format: "short",
    expected: ["4", "quatre"],
    explanation: expectedExplanation(["4", "quatre"]),
    comparator: "contains_keyword",
  ...
  // =========================
  {
    ...
    explanation: expectedExplanation(["0,5", "0.5", "1/2", "1 / 2"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["0,25", "0.25", "1/4", "1 / 4"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["0,75", "0.75", "3/4", "3 / 4"]),
    comparator: "fraction_decimal_equivalent",
    hint: "3 quarts = 0,75.",
    tags: ["fractions", "decimal"],
  },
  {
    ...
    expected: ["0,5", "0.5"],
    explanation: expectedExplanation(["0,5", "0.5"]),
    comparator: "mcq_exact",
    hint: "Une moitié.",
  ...
  },
  {
    ...
    expected: ["0,25", "0.25"],
    explanation: expectedExplanation(["0,25", "0.25"]),
    comparator: "mcq_exact",
    hint: "Un quart.",
    tags: ["fractions", "decimal", "qcm"],
  },
  ...
  },
  {
    ...
    expected: ["2/3", "2 / 3"],
    explanation: expectedExplanation(["2/3", "2 / 3"]),
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    expected: ["1/4", "1 / 4"],
    explanation: expectedExplanation(["1/4", "1 / 4"]),
    comparator: "mcq_exact",
  ...
  // =========================
  {
    ...
    explanation: expectedExplanation(["4/8", "4 / 8", "1/2", "1 / 2", "0,5", "0.5"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["3/4", "3 / 4", "0,75", "0.75"]),
    comparator: "fraction_decimal_equivalent",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["même", "quantité", "2/4", "1/2"]),
    comparator: "contains_keyword",
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([fractionString(num, den), fractionStringSpaced(num, den)]),
        comparator: "fraction_decimal_equivalent",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        format: "short",
        expected: [String(num)],
        explanation: expectedExplanation([String(num)]),
        comparator: "number_equal",
      };
    },
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        expected: [String(den)],
        explanation: expectedExplanation([String(den)]),
        comparator: "mcq_exact",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([String(expected)]),
        comparator: "number_equal",
      };
    },
  },
  ...
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([item.good, item.good.replace(",", ".")]),
        comparator: "mcq_exact",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([fractionString(max, den), fractionStringSpaced(max, den)]),
        comparator: "fraction_decimal_equivalent",
      };
    },
  },
  ...
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([item.answer]),
        comparator: "mcq_exact",
      };
    },
  },
