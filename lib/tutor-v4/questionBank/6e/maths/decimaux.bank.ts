  ...
  // =========================
{
  ...
  difficulty: 5,
  theme: "neutral",
  text: "Comment partager un gâteau en 6 parts égales ?",
  format: "qcm",
  choices: [
    "Faire des angles de 60° avec des triangles",
    "Couper le gâteau au hasard",
    "Faire 5 parts puis ajuster",
    "Couper en 3 parts puis recouper"
  ],
  expected: ["Faire des angles de 60° avec des triangles"],
  comparator: "mcq_exact",
  hint: "Un cercle fait 360°. 360 ÷ 6 = 60°.",
  tags: ["decimaux", "defi", "geometrie", "raisonnement", "qcm"],
},
  {
  kind: "fixed",
  ...
  difficulty: 4,
  theme: "neutral",
  text: ": L’addition est de 20 €. Hugo le serveur du Vavang'art est -sympa et tu veux lui laisser 5 % de pourboire. Combien donnes-tu de pourboire ?",
  format: "qcm",
  choices: ["0,5 €", "1 €", "5 €", "10 €"],
  expected: ["1 €", "1€", "1"],
  comparator: "mcq_exact",
  hint: "5 % signifie 5 sur 100. On calcule 5 % de 20.",
  tags: ["decimaux", "defi", "pourcentage", "vie_quotidienne", "qcm"],
},
  {
    kind: "fixed",
    ...
    difficulty: 5,
    theme: "neutral",
    text: "Pourquoi a-t-on changé de base 60 à base 100 ?",
    format: "short",
    expected: ["10", "100", "decimal"],
    comparator: "contains_keyword",
    hint: "Pense au système décimal et aux calculs plus simples.",
    tags: ["decimaux", "defi", "olympiade", "histoire", "raisonnement"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 5,
    theme: "neutral",
    text: "Pourquoi a-t-on créé les nombres décimaux ?",
    format: "short",
    expected: ["partager", "mesurer", "precision", "précision"],
    comparator: "contains_keyword",
    hint: "Pense aux mesures, aux partages et aux nombres entre deux entiers.",
    tags: ["decimaux", "defi", "sens", "raisonnement"],
  },
  {
    kind: "fixed",
    ...
    expected: ["10", "dix"],
    comparator: "contains_keyword",
    hint: "Le mot est lié au nombre 10.",
    tags: ["decimaux", "defi", "vocabulaire", "culture"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 5,
    theme: "neutral",
    text: "La soustraction de nombres entiers peut-elle donner un nombre décimal ?",
    format: "qcm",
    choices: ["oui", "non"],
    expected: ["non"],
    comparator: "mcq_exact",
    hint: "La différence de deux nombres entiers reste un entier.",
    tags: ["decimaux", "defi", "piege", "raisonnement", "qcm"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 4,
    theme: "reunion",
    text: "À La Réunion, un sentier fait 2,5 km. Pourquoi n’écrit-on pas 2 km et 50 m à la place ?",
    format: "short",
    expected: ["500", "metres", "mètres", "decimal", "décimal"],
    comparator: "contains_keyword",
    hint: "2,5 km signifie 2 km et une moitié de kilomètre.",
    tags: ["decimaux", "defi", "reunion", "mesure", "raisonnement"],
  },
  {
    kind: "fixed",
    ...
    difficulty: 4,
    theme: "neutral",
    text: "Un requin nage à 2,75 m/s. Pourquoi a-t-on besoin de nombres comme 2,75 et pas seulement 2 ou 3 ?",
    format: "short",
    expected: ["precision", "précision", "mesure"],
    comparator: "contains_keyword",
    hint: "Entre 2 et 3, on a besoin d’une valeur plus précise.",
    tags: ["decimaux", "defi", "nature", "mesure", "raisonnement"],
  },
  {
    kind: "fixed",
