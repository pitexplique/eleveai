...
export const decimauxBank: TutorBankItemV4[] = [
  ...
  // =========================
  {
    ...
    difficulty: 5,
    theme: "neutral",
    text: "Comment je fais pour partager un gâteau en 10 parts égales ?",
    format: "short",
    expected: ["10", "parts", "égales", "egales"],
    comparator: "contains_keyword",
    hint: "On coupe le gâteau en 10 parts de même taille.",
    tags: ["decimaux", "defi", "partage", "raisonnement"],
  },
  {
    kind: "fixed",
