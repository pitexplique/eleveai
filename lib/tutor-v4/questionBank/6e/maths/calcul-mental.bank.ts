...
export const calculMentalBank: TutorBankItemV4[] = [
  ...
  // =========================
  {
    ...
    hint: "68 + 2 = 70, puis + 5.",
    explanation:
      "Définition : le calcul mental consiste à effectuer un calcul sans poser l’opération.\n\nMéthode : on choisit une stratégie simple : décomposer, compléter, multiplier ou utiliser une propriété connue.\n\nCalcul : " +
      ("On peut passer par la dizaine : 68 + 2 = 70, puis il reste 5 à ajouter. Donc 68 + 7 = 75.") +
      "\n\nConclusion : le résultat obtenu répond au calcul demandé.",
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        expected: [String(sum)],
        comparator: "number_equal",
        explanation: "Définition : le calcul mental consiste à effectuer un calcul sans poser l’opération.\n\nMéthode : on choisit une stratégie simple : décomposer, compléter, multiplier ou utiliser une propriété connue.\n\nCalcul : " +
