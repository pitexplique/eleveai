...
export const trianglesBank: TutorBankItemV4[] = [
  ...
  // =========================
  {
    ...
    niveau: "6e", matiere: "maths",
    notionId: "triangle_figure", microId: "triangle_somme_angle",
    difficulty: 1, theme: "neutral",
  ...
  // =========================
  {
    ...
    niveau: "6e", matiere: "maths",
    notionId: "triangle_figure", microId: "triangle_angle_manquant",
    difficulty: 2, theme: "neutral",
  ...
  // =========================
  {
    ...
    niveau: "6e", matiere: "maths",
    notionId: "triangle_figure", microId: "triangle_possible_ou_non",
    difficulty: 2, theme: "neutral",
