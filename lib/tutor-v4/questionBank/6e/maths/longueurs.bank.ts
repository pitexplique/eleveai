...
export const longueursBank: TutorBankItemV4[] = [
  ...
  },
  {
    ...
    choices: ["cm", "mm", "km", "dm"],
    expected: ["km"],
    explanation: expectedExplanation(["km"]),
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    choices: ["km", "m", "cm", "mm"],
    expected: ["mm"],
    explanation: expectedExplanation(["mm"]),
    comparator: "mcq_exact",
  ...
  // =========================
  {
    ...
    format: "short",
    expected: ["100"],
    explanation: expectedExplanation(["100"]),
  ...
  },
  {
    ...
    format: "short",
    expected: ["1000"],
    explanation: expectedExplanation(["1000"]),
    comparator: "number_equal",
    hint: "1 km = 1000 m.",
    tags: ["longueurs", "unites"],
  },
  ...
  },
  {
    ...
    expected: ["100 cm"],
    explanation: expectedExplanation(["100 cm"]),
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    expected: ["1000 m"],
    explanation: expectedExplanation(["1000 m"]),
    comparator: "mcq_exact",
  ...
  // =========================
  {
    ...
    format: "short",
    expected: ["200"],
    explanation: expectedExplanation(["200"]),
    comparator: "number_equal",
    hint: "1 m = 100 cm.",
  ...
  },
  {
    ...
    format: "short",
    expected: ["4000"],
    explanation: expectedExplanation(["4000"]),
    comparator: "number_equal",
    hint: "1 km = 1000 m.",
    tags: ["longueurs", "conversion"],
  },
  ...
  },
  {
    ...
    format: "short",
    expected: ["250"],
    explanation: expectedExplanation(["250"]),
    comparator: "number_equal",
  ...
  },
  {
    ...
    expected: ["3000"],
    explanation: expectedExplanation(["3000"]),
    comparator: "mcq_exact",
    hint: "1 km = 1000 m.",
    tags: ["longueurs", "conversion", "qcm"],
  },
  {
    ...
    format: "short",
    expected: ["5000"],
    explanation: expectedExplanation(["5000"]),
    comparator: "number_equal",
  ...
  // =========================
  {
    ...
    expected: ["2 m"],
    explanation: expectedExplanation(["2 m"]),
    comparator: "mcq_exact",
  ...
  },
  {
    ...
    expected: ["250 cm"],
    explanation: expectedExplanation(["250 cm"]),
    comparator: "mcq_exact",
    hint: "3 m = 300 cm.",
    tags: ["longueurs", "comparaison"],
  },
  {
    ...
    explanation: expectedExplanation(["1,5 m", "1.5 m", "150 cm"]),
  ...
  },
  {
    ...
    expected: ["1 m"],
    explanation: expectedExplanation(["1 m"]),
    comparator: "mcq_exact",
    hint: "1 m = 100 cm.",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["3 km", "3000 m"]),
    comparator: "contains_keyword",
    hint: "3 km = 3000 m.",
  ...
  },
  {
    ...
    format: "short",
    expected: ["150"],
    explanation: expectedExplanation(["150"]),
    comparator: "number_equal",
    hint: "2 m = 200 cm.",
    tags: ["longueurs", "probleme"],
  },
  {
    ...
    format: "short",
    expected: ["1"],
    explanation: expectedExplanation(["1"]),
    comparator: "number_equal",
  ...
  // =========================
  {
    ...
    explanation: expectedExplanation(["unité adaptée", "trop petit", "pas adapté", "grande distance"]),
    comparator: "contains_keyword",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["200", "150", "cm", "m"]),
    comparator: "contains_keyword",
  ...
  },
  {
    ...
    explanation: expectedExplanation(["101", "110", "120", "130", "140", "149"]),
  ...
  },
  {
    ...
    format: "short",
    expected: ["3500"],
    explanation: expectedExplanation(["3500"]),
    comparator: "number_equal",
    hint: "2 km = 2000 m.",
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        expected: [item.good],
        explanation: expectedExplanation([item.good]),
        comparator: "mcq_exact",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        format: "short",
        expected: [item.a],
        explanation: expectedExplanation([item.a]),
        comparator: "number_equal",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([String(m * 100)]),
        comparator: "number_equal",
      };
    },
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([String(km * 1000)]),
        comparator: "number_equal",
      };
    },
  },
  ...
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([good, String(Math.max(metersInCm, centimeters))]),
        comparator: "contains_keyword",
      };
    },
  },
  ...
  // =========================
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation([String(low + 1), String(low + 10), String(high - 1)]),
        comparator: "exact_text",
      };
    },
  },
  {
    ...
    generate: () => {
      ...
      return {
        ...
        explanation: expectedExplanation(["unité", "adaptée", "mesurer"]),
        comparator: "contains_keyword",
      };
    },
  },
