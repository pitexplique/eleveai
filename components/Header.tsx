...
const NAV_MATHS = [
  ...
  { href: "/cahier-vacances/vers-le-cm2", icon: "☀️", label: "Cahier vacances CM2", desc: "Vers le CM2 : 1 page/jour à imprimer" },
  { href: "/cahier-vacances/vers-la-6e", icon: "☀️", label: "Cahier vacances 6e", desc: "Vers la 6e : 1 page/jour à imprimer" },
