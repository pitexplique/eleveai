          ...
          <div className="relative mt-8 text-center">
            ...
            <p className="mt-2 text-sm font-bold italic text-slate-500">
              {/* Signée comme les deux autres cahiers (20/08/2026) — voir la
                  ...
                  ⚠️ « Et pour toi » bien que la couverture parle à l'adulte qui
                  accompagne (« à faire avec votre enfant », plus bas) : le site
                  tutoie tout le monde depuis sa porte d'entrée, et la signature
                  ne change pas de personne d'une page à l'autre. */}
